...
package com.cobiscorp.cobis.front.customevents.impl.queryview.rowupdating;
...
public class ClienteQuery_QV_BN94_GSD54 implements IGridRowUpdating {
	/**
	 * Instancia de Logger
	 */
	...
	@Reference(bind="setBliActualizarCliente" , 
			...
			target = "(bli.id=BLI4302_bli_actualizarcliente)")
