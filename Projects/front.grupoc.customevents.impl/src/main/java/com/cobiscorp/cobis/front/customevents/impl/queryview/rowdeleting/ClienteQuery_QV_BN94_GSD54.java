...
public class ClienteQuery_QV_BN94_GSD54 implements IGridRowDeleting {
	/**
	 * Instancia de Logger
	 */
	...
	@Reference(bind="setBliEliminarCliente" , 
			...
			target = "(bli.id=BLI9836_bli_eliminarcliente)")
	private IBLIExecutor bliEliminarCliente;
	
	private void setBliEliminarCliente(IBLIExecutor bliEliminarCliente){
		this.bliEliminarCliente = bliEliminarCliente;
	}
	
	private void unsetBliEliminarCliente(IBLIExecutor bliEliminarCliente){
