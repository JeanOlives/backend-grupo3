/*
 * Archivo: T_FRONTKNVSTNQU_714.java
 * Fecha: 2021-04-24T19:18:51Z
 *
 ...
 * T_FRONTKNVSTNQU_714 - ClienteForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTKNVSTNQU_714")
@Component
@Service({T_FRONTKNVSTNQU_714.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTKNVSTNQU_714)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTEKUO_145", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTEKUO_145)(view.version=1.0.0))")
,@Reference (name="QV_BN94_GSD54",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_BN94_GSD54)")
,@Reference(name="Q_CLIETTTN_SG94",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIETTTN_SG94)(query.version=1.0.0))")
...
public class T_FRONTKNVSTNQU_714 {
