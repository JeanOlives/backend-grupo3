 ...
 * T_FRONTKRDHZFNX_407 - IngresarProductoForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTKRDHZFNX_407")
@Component
@Service({T_FRONTKRDHZFNX_407.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTKRDHZFNX_407)(task.version=1.0.0))")
,@Reference(name="VW_INGRESARRR_207", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_INGRESARRR_207)(view.version=1.0.0))")
...
public class T_FRONTKRDHZFNX_407 {
