/*
 * Archivo: T_FRONTCKYWUYUY_796.java
 * Fecha: 2021-04-24T19:18:08Z
 *
 ...
 * T_FRONTCKYWUYUY_796 - ProductoForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTCKYWUYUY_796")
@Component
@Service({T_FRONTCKYWUYUY_796.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTCKYWUYUY_796)(task.version=1.0.0))")
,@Reference(name="VW_PRODUCTORD_668", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRODUCTORD_668)(view.version=1.0.0))")
,@Reference (name="QV_VD43_EWG54",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_VD43_EWG54)")
,@Reference(name="Q_PRODCCTC_GC43",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRODCCTC_GC43)(query.version=1.0.0))")
...
public class T_FRONTCKYWUYUY_796 {
