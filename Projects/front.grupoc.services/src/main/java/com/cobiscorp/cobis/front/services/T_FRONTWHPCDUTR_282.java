/*
 * Archivo: T_FRONTWHPCDUTR_282.java
 * Fecha: 2021-04-24T19:19:16Z
 *
 ...
 */
package com.cobiscorp.cobis.front.services;
 ...
 * T_FRONTWHPCDUTR_282 - BuscarClienteForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTWHPCDUTR_282")
@Component
@Service({T_FRONTWHPCDUTR_282.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTWHPCDUTR_282)(task.version=1.0.0))")
,@Reference(name="VW_BUSCARCLNT_247", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BUSCARCLNT_247)(view.version=1.0.0))")
,@Reference (name="QV_GV47_WDR34",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_GV47_WDR34)")
,@Reference(name="Q_CLIETNTE_TM47",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIETNTE_TM47)(query.version=1.0.0))")
...
public class T_FRONTWHPCDUTR_282 {
