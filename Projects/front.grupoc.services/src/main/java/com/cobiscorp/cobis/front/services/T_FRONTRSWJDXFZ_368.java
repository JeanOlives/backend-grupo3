/*
 * Archivo: T_FRONTRSWJDXFZ_368.java
 * Fecha: 2021-04-24T19:13:32Z
 *
 ...
 * T_FRONTRSWJDXFZ_368 - BuscarProductoForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTRSWJDXFZ_368")
@Component
@Service({T_FRONTRSWJDXFZ_368.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTRSWJDXFZ_368)(task.version=1.0.0))")
,@Reference(name="VW_BUSCARPROT_401", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BUSCARPROT_401)(view.version=1.0.0))")
...
public class T_FRONTRSWJDXFZ_368 {
