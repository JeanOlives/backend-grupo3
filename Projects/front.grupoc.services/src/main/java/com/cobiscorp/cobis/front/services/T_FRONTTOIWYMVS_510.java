/*
 * Archivo: T_FRONTTOIWYMVS_510.java
 * Fecha: 2021-04-24T17:28:14Z
 *
 ...
 * T_FRONTTOIWYMVS_510 - FacturacionForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTTOIWYMVS_510")
@Component
@Service({T_FRONTTOIWYMVS_510.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTTOIWYMVS_510)(task.version=1.0.0))")
,@Reference(name="VW_FACTURACIN_877", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_FACTURACIN_877)(view.version=1.0.0))")
,@Reference (name="QV_OZ58_ZJI21",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_OZ58_ZJI21)")
,@Reference(name="Q_DETACRUA_DQ58",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DETACRUA_DQ58)(query.version=1.0.0))")
...
public class T_FRONTTOIWYMVS_510 {
