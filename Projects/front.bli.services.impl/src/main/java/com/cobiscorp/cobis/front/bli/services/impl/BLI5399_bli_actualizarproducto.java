...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI5399_bli_actualizarproducto")
})
public class BLI5399_bli_actualizarproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI5399_bli_actualizarproducto.class);
