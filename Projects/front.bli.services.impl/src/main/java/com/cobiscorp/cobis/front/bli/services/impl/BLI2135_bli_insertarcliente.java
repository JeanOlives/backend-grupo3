...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI2135_bli_insertarcliente")
})
public class BLI2135_bli_insertarcliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI2135_bli_insertarcliente.class);
