...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI3835_bli_mostarcliente")
})
public class BLI3835_bli_mostarcliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI3835_bli_mostarcliente.class);
