...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI6230_bli_insertarproducto")
})
public class BLI6230_bli_insertarproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI6230_bli_insertarproducto.class);
