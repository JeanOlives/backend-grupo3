...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI3203_bli_mostarproducto")
})
public class BLI3203_bli_mostarproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI3203_bli_mostarproducto.class);
